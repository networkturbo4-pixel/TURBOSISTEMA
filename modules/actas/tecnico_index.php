...
<style>
    ...
    /* Grid de Actas - 1fr para vista móvil nativa */
    .actas-grid {
        display: grid;
...
<!-- Barra de Filtros Minimalista para Técnico -->
<div class="filter-bar" style="padding: 12px; gap: 8px;">
    <div class="filter-search" style="flex: 1; min-width: 100%;">
        <i class="ph ph-magnifying-glass"></i>
        <input type="text" class="form-control" id="searchFilter" placeholder="Buscar por folio, cliente o DNI..." style="border-radius: 10px;">
    </div>
    <!-- Filtros ocultos por defecto para que el JS global no falle -->
    <select class="form-select" id="techFilter" style="display:none;"><option value=""></option></select>
    <input type="date" class="form-control" id="dateFilter" style="display:none;">
    <input type="text" class="form-control" id="dniFilter" style="display:none;">
    <input type="text" class="form-control" id="folioFilter" style="display:none;">
    <button class="btn btn-clear" id="btnClear" style="display:none;">Limpiar</button>
</div>
...
<a href="<?php echo BASE_URL; ?>/modules/actas/tecnico_create.php" class="fab" title="Crear Acta">
