...
$stmt = $pdo->query("SELECT * FROM inventory_products ORDER BY id DESC LIMIT 1");
...
echo "Editing product ID: " . $prod['id'] . "\n";

$_POST['action'] = 'update_product';
$_POST['product_id'] = $prod['id'];
$_POST['name'] = $prod['name'] . ' (Edited)';
$_POST['category_id'] = $prod['category_id'];
$_POST['stock_minimo'] = 5;
$_POST['stock_critico'] = 2;
$_POST['description'] = 'Test desc edited';
...
try {
    ...
    // Verify update
    $stmt2 = $pdo->query("SELECT name FROM inventory_products WHERE id = " . $prod['id']);
    echo "New name: " . $stmt2->fetchColumn() . "\n";
